...
1;for(n=b?1:0;0<=n;n--){l=n||!b?f.channelCurves[c]:f.actualChannelCurve;d.strokeStyle=n?"#707070":this.rangeImage;d.beginPath();d.moveTo(g*e|0,l[0]*e+k);for(m=1;m<a;m++)d.lineTo((g+m)*e|0,l[m]*e+k);d.lineTo((g+m+1)*e|0,l[m]*e+k);d.stroke()}}}}
...
if(a&&b&&c&&d){var e=GraphicalFilterEditorControl.controlWidth,g=GraphicalFilterEditorControl.controlHeight,f=1<devicePixelRatio?devicePixelRatio:1,k=b.scale,h=k*f,n=this.leftMargin,l=this.svgLines,q=1>h?h:h|0,t=.5*q,p=(e*h|0).toString(),m=(g*h|0).toString();d.setAttribute("width",p);d.setAttribute("height",m);d.setAttribute("viewBox",`0 0 ${p} ${m}`);d.style.transform=1===f?"":"scale("+1/f+")";this.svgGradient.setAttribute("y2",m);b.element.style.width=(e*k|0)+"px";a.style.width=(e*k|0)+"px";a.style.height=
(g*k|0)+"px";l[0].setAttribute("x2",p);l[1].setAttribute("x2",p);for(p=l.length-1;2<=p;p--)l[p].setAttribute("y2",m);m=((GraphicalFilterEditor.zeroChannelValueY*h|0)+t).toString();l[0].setAttribute("y1",m);l[0].setAttribute("y2",m);m=((GraphicalFilterEditor.validYRangeHeight*h|0)+t).toString();l[1].setAttribute("y1",m);l[1].setAttribute("y2",m);for(m=c.equivalentZonesFrequencyCount.length-2;0<m;m--)p=(((c.equivalentZonesFrequencyCount[m]+n)*h|0)+t).toString(),l[m+1].setAttribute("x1",p),l[m+1].setAttribute("x2",
p);p=q.toString()+"px";m=(4*h|0).toString();for(c=l.length-1;0<=c;c--)l[c].setAttribute("stroke-width",p),l[c].setAttribute("stroke-dasharray",m);p=(1>h?2*h:2*h|0).toString()+"px";this.svgGrayCurve.style.strokeWidth=p;this.svgCurve.style.strokeWidth=p;this.pixelRatio=f}}drawCurve(a,b,c){var d=1<devicePixelRatio?devicePixelRatio:1;d!==this.pixelRatio&&(this.scaleChanged(),d=this.pixelRatio);this.showZones!==a&&(this.showZones=a,this.svgZones.style.display=a?"":"none");var e=this.editor;a=e.filter;
d*=e.scale;e=.5*(1>d?2*d:2*d|0);const g=this.leftMargin,f=GraphicalFilterEditor.visibleBinCount;for(let k=b?1:0;0<=k;k--){const h=k||!b?a.channelCurves[c]:a.actualChannelCurve,n=k?this.svgGrayCurve:this.svgCurve;let l=1,q=0,t=h[0],p="M "+(g*d|0)+","+(t*d+e);for(;l<f;l++)h[l]!==t&&(l>q+1&&1<l&&(p+=" "+((g+l-1)*d|0)+","+(h[l-1]*d+e)),q=l,t=h[l],p+=" "+((g+q)*d|0)+","+(t*d+e));p+=" "+((g+l)*d|0)+","+(h[l-1]*d+e);n.setAttribute("d",p)}this.isActualChannelCurveNeeded!==b&&(this.isActualChannelCurveNeeded=
...
cancelEvent;a.appendChild(this.renderer.element);this.pointerHandler=new PointerHandler(this.renderer.element,this.mouseDown.bind(this),this.mouseMove.bind(this),this.mouseUp.bind(this));a.oncontextmenu=cancelEvent;var f=document.createElement("div");f.className="GELBL";f.style.width="11em";f.appendChild(document.createTextNode(GraphicalFilterEditorStrings.Cursor));f.appendChild(this.lblCursor=document.createElement("span"));f.appendChild(document.createTextNode(" dB"));this.lblCursor.appendChild(document.createTextNode(GraphicalFilterEditorStrings.Minus0));
...
class Program{static create(a,b,c,d){const e=["webkit-3d","moz-webgl","webgl","experimental-webgl"];for(let g=0;g<e.length;g++)try{const f=a.getContext(e[g],b);return new Program(f,c,d)}catch(f){}return null}constructor(a,b,c){const d=[];var e=[];const g=[];this.gl=a;var f=a.createProgram();if(!f)throw Error("Null program");this.program=f;f=a.createShader(a.VERTEX_SHADER);if(!f)throw Error("Null vertex shader");this.vs=f;f=a.createShader(a.FRAGMENT_SHADER);if(!f)throw Error("Null fragment shader");
this.fs=f;a.shaderSource(this.vs,b);a.compileShader(this.vs);if(!a.getShaderParameter(this.vs,a.COMPILE_STATUS))throw e="Vertex shader: "+a.getShaderInfoLog(this.vs),this.destroy(),alert(e),e;this.getAttribsAndUniforms(b,d,e,g);a.shaderSource(this.fs,c);a.compileShader(this.fs);if(!a.getShaderParameter(this.fs,a.COMPILE_STATUS))throw e="Fragment shader: "+a.getShaderInfoLog(this.fs),this.destroy(),alert(e),e;this.getAttribsAndUniforms(c,d,e,g);a.attachShader(this.program,this.vs);a.attachShader(this.program,
this.fs);for(b=0;b<d.length;b++)a.bindAttribLocation(this.program,b,d[b]);a.linkProgram(this.program);for(a=0;a<e.length;a++)this.prepareUniform(e[a],g[a])}getAttribsAndUniforms(a,b,c,d){a=a.split("\n");for(let n=0;n<a.length;n++){var e=a[n].trim();if("uniform"===e.substring(0,7)){e=e.split(" ");var g=e[1];for(var f=2;f<e.length;f++){var k=e[f];if(";"===k)break;var h=k.charAt(k.length-1);const l=";"===h;if(","===h||l)k=k.substring(0,k.length-1);","!==k&&k.length&&(c.push(k),d.push(g));if(l)break}}else if("attribute"===
