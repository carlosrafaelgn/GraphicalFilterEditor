...
this.pointerUp.bind(this),this.boundDocumentMove=this.pointerMove.bind(this),a.onpointerdown=this.pointerDown.bind(this)):"ontouchstart"in a?(this.documentMoveEvent="touchmove",this.documentUpEvent="touchup",this.documentCancelEvent="touchcancel",this.boundDocumentUp=this.touchEnd.bind(this),this.boundDocumentMove=this.touchMove.bind(this),a.ontouchstart=this.touchStart.bind(this)):(this.documentMoveEvent="mousemove",this.documentUpEvent="mouseup",this.documentCancelEvent=null,this.boundDocumentUp=
