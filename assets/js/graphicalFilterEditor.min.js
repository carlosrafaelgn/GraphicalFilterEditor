...
cancelEvent;a.appendChild(this.renderer.element);this.pointerHandler=new PointerHandler(this.renderer.element,this.mouseDown.bind(this),this.mouseMove.bind(this),this.mouseUp.bind(this));a.oncontextmenu=cancelEvent;var f=document.createElement("div");f.className="GELBL";f.style.width="9em";f.appendChild(document.createTextNode(GraphicalFilterEditorStrings.Cursor));f.appendChild(this.lblCursor=document.createElement("span"));f.appendChild(document.createTextNode(" dB"));this.lblCursor.appendChild(document.createTextNode(GraphicalFilterEditorStrings.Minus0));
a.appendChild(f);f=document.createElement("div");f.className="GELBL";f.style.width="9em";f.appendChild(document.createTextNode(GraphicalFilterEditorStrings.Curve));f.appendChild(this.lblCurve=document.createElement("span"));f.appendChild(document.createTextNode(" dB"));this.lblCurve.appendChild(document.createTextNode(GraphicalFilterEditorStrings.Minus0));a.appendChild(f);f=document.createElement("div");f.className="GELBL";f.appendChild(document.createTextNode(GraphicalFilterEditorStrings.Frequency));
f.appendChild(this.lblFrequency=document.createElement("span"));this.lblFrequency.appendChild(document.createTextNode("0 Hz (31 Hz)"));a.appendChild(f);this.btnMnu=document.createElement("div");this.btnMnu.className="GEBTN GECLK";this.openMenuElement=null;this.openMenuCharacter="\u25b2";this.closeMenuElement=null;this.closeMenuCharacter="\u25bc";g&&(f=!1,g.openMenuHTML&&g.closeMenuHTML?(f=!0,this.btnMnu.innerHTML=g.openMenuHTML+g.closeMenuHTML,this.openMenuElement=this.btnMnu.childNodes[0],this.closeMenuElement=
this.btnMnu.childNodes[1],this.closeMenuElement.style.display="none"):g.openMenuCharacter?(f=!0,this.openMenuCharacter=g.openMenuCharacter,this.closeMenuCharacter=g.closeMenuCharacter||this.openMenuCharacter):g.closeMenuCharacter&&(f=!0,this.closeMenuCharacter=this.openMenuCharacter=g.closeMenuCharacter),f&&(g.menuFontFamily&&(this.btnMnu.style.fontFamily=g.menuFontFamily),g.menuFontSize&&(this.btnMnu.style.fontSize=g.menuFontSize),g.menuWidth&&(this.btnMnu.style.width=g.menuWidth),g.menuPadding&&
(this.btnMnu.style.padding=g.menuPadding)));this.openMenuElement||this.btnMnu.appendChild(document.createTextNode(this.openMenuCharacter));this.btnMnu.onclick=this.btnMnu_Click.bind(this);a.appendChild(this.btnMnu);this.mnu=document.createElement("div");this.mnu.className="GEMNU";this.mnu.style.display="none";f=document.createElement("div");f.className="GEMNUH GEFILTER";f.appendChild(c(GraphicalFilterEditorStrings.SameCurve));f.appendChild(this.mnuChBL=d(GraphicalFilterEditorStrings.UseLeftCurve,
!0,!0,!0,this.mnuChB_Click.bind(this,0)));f.appendChild(this.mnuChBR=d(GraphicalFilterEditorStrings.UseRightCurve,!0,!1,!0,this.mnuChB_Click.bind(this,1)));f.appendChild(b());f.appendChild(c(GraphicalFilterEditorStrings.OneForEach));f.appendChild(this.mnuChL=d(GraphicalFilterEditorStrings.ShowLeftCurve,!0,!1,!0,this.mnuChLR_Click.bind(this,0)));f.appendChild(this.mnuChR=d(GraphicalFilterEditorStrings.ShowRightCurve,!0,!1,!0,this.mnuChLR_Click.bind(this,1)));this.mnu.appendChild(f);f=document.createElement("div");
f.className="GEMNUH GEMNUSEPH";f.appendChild(d(GraphicalFilterEditorStrings.ResetCurve,!1,!1,!1,this.mnuResetCurve_Click.bind(this)));f.appendChild(b());f.appendChild(c(GraphicalFilterEditorStrings.EditMode));f.appendChild(this.mnuEditRegular=d(GraphicalFilterEditorStrings.Regular,!0,!0,!0,this.mnuEditRegular_Click.bind(this)));f.appendChild(this.mnuEditZones=d(GraphicalFilterEditorStrings.Zones,!0,!1,!0,this.mnuEditZones_Click.bind(this)));f.appendChild(this.mnuEditSmoothNarrow=d(GraphicalFilterEditorStrings.SmoothNarrow,
!0,!1,!0,this.mnuEditSmoothNarrow_Click.bind(this)));f.appendChild(this.mnuEditSmoothWide=d(GraphicalFilterEditorStrings.SmoothWide,!0,!1,!0,this.mnuEditSmoothWide_Click.bind(this)));f.appendChild(this.mnuEditPeakingEq=d(GraphicalFilterEditorStrings.PeakingEq,!0,!1,!0,this.mnuEditPeakingEq_Click.bind(this)));if(g&&g.hideEditModePeakingEq||!this.filter.iirSupported)this.mnuEditPeakingEq.style.display="none";f.appendChild(this.mnuEditShelfEq=d(GraphicalFilterEditorStrings.ShelfEq,!0,!1,!0,this.mnuEditShelfEq_Click.bind(this)));
if(g&&g.hideEditModeShelfEq||!this.filter.iirSupported)this.mnuEditShelfEq.style.display="none";f.appendChild(b());f.appendChild(this.mnuNormalizeCurves=d(GraphicalFilterEditorStrings.NormalizeCurves,!0,!1,!1,this.mnuNormalizeCurves_Click.bind(this),"GEFILTER"));f.appendChild(this.mnuShowZones=d(GraphicalFilterEditorStrings.ShowZones,!0,!1,!1,this.mnuShowZones_Click.bind(this)));f.appendChild(this.mnuShowActual=d(GraphicalFilterEditorStrings.ShowActualResponse,!0,!0,!1,this.mnuShowActual_Click.bind(this)));
this.mnu.appendChild(f);a.appendChild(this.mnu);e&&this.loadSettings(e);this.drawCurve()}destroy(){this.filter&&this.filter.destroy();this.pointerHandler&&this.pointerHandler.destroy();this.renderer&&this.renderer.destroy();zeroObject(this)}loadSettings(a){if(a){var b=this.filter;if(!1===a.showZones||!0===a.showZones)this._showZones=a.showZones;a.editMode&&a.editMode>=GraphicalFilterEditorControl.editModeFirst&&a.editMode<=GraphicalFilterEditorControl.editModeLast&&(b.iirSupported||a.editMode!==GraphicalFilterEditorControl.editModePeakingEq&&
